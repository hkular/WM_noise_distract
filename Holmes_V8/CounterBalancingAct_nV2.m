function [TrialStuff, designMat, trial_cnt_shuffled, MinNumTrials] = CounterBalancingAct_nV2(OrientBins, Kappa, Distractor)
%Syntax:
...
designMat = repmat(designMat,20,1); % replicate for 360 trials total
...
for i = 1:length(designMat)
        ...
        trial.distractor = Distractor(designMat(trial_cnt_shuffled(i),2));
        trial.kappa = Kappa(designMat(trial_cnt_shuffled(i),3)); 
