...
%subs = ['01';'02';'03';'04';'05';'06';'07';'08';'09';'10';'11';'12';'13']; % S1-13 funky data with err n-1
...
myFolder = pwd;
filePattern = fullfile(myFolder, 'WM_noiseV9_S*');
...
eval(['save(''WM_noiseV9_', num2str(TheDate), '.mat'', ''all_dat'', ''-v7.3'')']);

 %change this to update the date                                               
writetable(struct2table(all_dat),'WM_noiseV9.csv');
