...
p.shortTrial = 1; % 0 if regular length, 1 if short for debugging
p.debug = 0;
p.MRI = 0;
...
if p.environment == 1
    if p.portCodes == 1
        ...
        p.GeneralUseScripts = '/Users/Documents/FYP/Github/noisefx/GeneralUseScripts';
    end
...
if practice == 'y'
    WM_noiseV11practice(p, info, 3, 1);
end
WM_noiseV11(p, info, 2, 1);
